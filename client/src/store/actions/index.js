import { SET_LOCATION_TEXT_INPUT, SET_LOCATION_RADIO_INPUT, 
         SET_DEFAULT_TEXT_INPUT, GET_WEATHER_DATA, LOADING_WEATHER_DATA, 
         LOADED_WEATHER_DATA, ERROR_WEATHER_DATA, SET_DEFAULT_INPUT } from './action-types';
...
export { SET_LOCATION_TEXT_INPUT, SET_LOCATION_RADIO_INPUT, 
  SET_DEFAULT_TEXT_INPUT, GET_WEATHER_DATA, LOADING_WEATHER_DATA, 
  LOADED_WEATHER_DATA, ERROR_WEATHER_DATA, SET_DEFAULT_INPUT }